        ...
        for index, row in self.schedule_data_frame.iterrows():
            ...
            for speciality in major:
                if discipline not in final_parsed_data[self._faculty_name][SPECIALITIES_FIELD_NAME][speciality]:
                    final_parsed_data[self._faculty_name][SPECIALITIES_FIELD_NAME][speciality][discipline] = {}
                if group not in final_parsed_data[self._faculty_name][SPECIALITIES_FIELD_NAME][speciality][discipline]:
                    final_parsed_data[self._faculty_name][SPECIALITIES_FIELD_NAME][speciality][discipline][group] = {}
